...
image_data = pd.read_csv('train_set1000.csv', low_memory=False)
...
new_data = pd.read_csv('pred_set3000.csv', low_memory=False)
...
existing_data = pd.read_csv('pred_set3000.csv', low_memory=False)
existing_data = existing_data.drop(columns=['Band_1', 'Band_2', 'Band_3', 'Band_4'])
...
output_file = 'result3001.csv'  # Change this path if needed
try:
