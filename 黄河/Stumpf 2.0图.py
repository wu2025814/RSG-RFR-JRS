...
image_data = pd.read_csv('testdata.csv', low_memory=False)
...
new_data = pd.read_csv('image1.csv', low_memory=False)
...
existing_data = pd.read_csv('image1.csv', low_memory=False)
...
output_file = 'result-.csv'  # Change this path if needed
try:
