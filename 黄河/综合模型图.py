...
# 加载数据（请确保文件路径和文件名正确）
train_data = pd.read_csv("xunlian.csv", low_memory=False)
test_data = pd.read_csv("yanzheng.csv", low_memory=False)
...
plt.tight_layout()
plt.savefig("新模型0001.jpg", dpi=600)
plt.show()
