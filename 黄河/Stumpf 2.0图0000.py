...
image_data = pd.read_csv('xunlian.csv', low_memory=False)
...
new_data = pd.read_csv('yanzheng.csv', low_memory=False)
...
existing_data = pd.read_csv('yanzheng.csv', low_memory=False)
...
output_file = 'result0001.csv'  # Change this path if needed
try:
